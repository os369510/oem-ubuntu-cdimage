...
sudo unsquashfs ../$1
cd squashfs-root
sudo cp $2/keyrings/ubuntu-archive-keyring.gpg usr/share/keyrings/ubuntu-archive-keyring.gpg
sudo cp $2/keyrings/ubuntu-archive-keyring.gpg etc/apt/trusted.gpg
